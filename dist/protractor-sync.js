...
'use strict';
exports.IMPLICIT_WAIT_MS = 5000;
exports.RETRY_INTERVAL = 10;
...
function _polledWait(fn, onTimeout, waitTimeMs) {
    ...
    var timeout = waitTimeMs || exports.IMPLICIT_WAIT_MS;
    var result;
    ...
    while (true) {
        if (new Date().getTime() - startTime.getTime() < timeout) {
            ...
            if (result.keepPolling) {
                flow.sync(setTimeout(flow.add(), exports.RETRY_INTERVAL)); //Wait a bit before checking again
            }
            else {
                break;
            }
        ...
        if (args.requireVisible) {
            filtered = resolved.filter(function (element) {
                try {
                    ...
                    //If the element has been removed from the DOM between when it was selected and now, don't treat it as an error and fail the test.
...
function patchElementFinder() {
    ...
    elPrototype.waitUntil = function (condition) {
        ...
        _polledWait(function () {
            ...
            throw new Error('Timed out(' + exports.IMPLICIT_WAIT_MS + ') waiting for condition: ' + condition);
        });
        return this;
    };
    elPrototype.waitUntilRemoved = function () {
        ...
        _polledWait(function () {
            ...
            throw new Error('Timed out(' + exports.IMPLICIT_WAIT_MS + ') waiting for element to be removed');
        });
        return this;
    };
    //JQuery methods
...
exports.patch = patch;
exports.disallowMethods = (function () {
    var ALLOWED_LOCATIONS = ['node_modules', 'protractor-sync.'];
...
//# sourceMappingURL=protractor-sync.js.map