...
declare module protractor {
  ...
  interface Element {
     ...
     */
    findVisible(locator: webdriver.Locator): ElementFinder;
     ...
     * @param locator An element locator
     */
    findVisibles(locator: webdriver.Locator): ElementFinder[];
     ...
     * @param locator An element locator
     */
    findElement(locator: webdriver.Locator): ElementFinder;
     ...
     * @param locator An element locator
     */
    findElements(locator: webdriver.Locator): ElementFinder[];
     ...
     * @param locator An element locator
     */
    assertElementDoesNotExist(locator: webdriver.Locator): boolean;
  ...
  interface ElementFinder {
     ...
     */
    isElementPresent(locator: webdriver.Locator, ...var_args: any[]): boolean;
  ...
  class Protractor extends webdriver.WebDriver {
    ...
    /**
     * Pauses the test and allows you to interact with the browser, including
     * debugging in the browser console. Note: you will need to close the console
     * before continuing the tests.
     *
     * This works even when the tests are not in debug mode.
     *
     */
    pause(): void;

    /**
     * Waits for the condition function to return a truthy value. An exception will be raised if it times out.
     *
     * @param condition The condition to wait for before proceeding
     * @param waitTimeMs When a non-zero value is specified, overrides the implicit wait time
     */
    waitFor(condition: () => boolean, waitTimeMs?: number): void;
