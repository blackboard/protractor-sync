...
declare module webdriver {
    ...
    class WebDriverTargetLocator {
         ...
         * <p/>
         * If the frame is specified by a WebElement, the command will select the frame
         * rooted at that WebElement
         * <p/>
        ...
        frame(element: WebElement): webdriver.promise.Promise;
    ...
    class WebDriver {
         ...
         */
        executeScript(script: string, ...var_args: any[]): any;
        executeScript(script: any, ...var_args: any[]): any;
